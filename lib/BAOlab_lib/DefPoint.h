...
class ArrayPoint {
   ...
   public:
    ...
    ArrayPoint(){Np=0;Dim=0;TabPoint=NULL;};
    ...
    int dim () const  {return Dim;}  // return the dimensionxmm_detect -M5 -v -E1.0e-4 src1.fits xmm_src4
    ...
    void read(char *FileName, Bool Verbose=False);
